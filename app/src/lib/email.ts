...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif">
      ...
      <table width="100%" style="max-width:520px;background:#111;border:1px solid rgba(255,255,255,0.08);border-radius:16px;overflow:hidden">
        ...
        <tr><td style="padding:36px 40px">
          ...
          <p style="margin:0 0 20px;color:rgba(255,255,255,0.6);font-size:14px;line-height:1.7">
            O diagnóstico da <strong style="color:#fff">${empresa}</strong>${cidade ? ` (${cidade}/${estado})` : ""} que você registrou no sistema está com as métricas em branco.
          </p>
          <p style="margin:0 0 28px;color:rgba(255,255,255,0.6);font-size:14px;line-height:1.7">
            Campos como <strong style="color:#fff">total de corretores, propostas mensais e VGV</strong> precisam ser preenchidos para que o diagnóstico seja contabilizado no BI. Acesse o sistema e complete as informações quando puder.
          </p>
  ...
  await sparkPost(html, `Diagnóstico ${empresa} pendente de finalização`, email, nome);
}
